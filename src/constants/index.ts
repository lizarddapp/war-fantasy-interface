...
export const GOVERNANCE_TOKEN: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.BSC_TESTNET]: new Token(ChainId.BSC_TESTNET, '0x955F82C58dCd3c1369769aEc1Bbd80611b1cff30', 18, 'COBRA', 'Cobra'),
  [ChainId.HARMONY_MAINNET]: new Token(ChainId.HARMONY_MAINNET, '0xEa589E93Ff18b1a1F1e9BaC7EF3E86Ab62addc79', 18, 'VIPER', 'Viper'),
  [ChainId.HARMONY_TESTNET]: new Token(ChainId.HARMONY_TESTNET, '0x69A655c56087D927eb05247FB56495a0f19B9f70', 18, 'VIPER', 'Viper')
}
...
export const PIT: { [chainId in ChainId]: Token } = {
  ...
  [ChainId.BSC_TESTNET]: new Token(ChainId.BSC_TESTNET, '0x6F08B9914A4BDce7a2220D9f72BC2728Bc083A18', 18, 'xCOBRA', 'CobraDen'),
  [ChainId.HARMONY_MAINNET]: new Token(ChainId.HARMONY_MAINNET, '0xE064a68994e9380250CfEE3E8C0e2AC5C0924548', 18, 'xVIPER', 'ViperPit'),
  [ChainId.HARMONY_TESTNET]: new Token(ChainId.HARMONY_TESTNET, '0x1e11CA9830Cd3a9867990CE2769EDf77F21ae5FA', 18, 'xVIPER', 'ViperPit')
}
...
export const SUGGESTED_BASES: ChainTokenList = {
  ...
  [ChainId.HARMONY_MAINNET]: [...WETH_ONLY[ChainId.HARMONY_MAINNET], getTokenWithDefault(ChainId.HARMONY_MAINNET, 'BUSD'), getTokenWithDefault(ChainId.HARMONY_MAINNET, 'VIPER')]
}
