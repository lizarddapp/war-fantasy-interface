...
import { abi as ARMY_ABI } from '../constants/abis/Army.json'
...
export function useArmyContract(withSignerIfPossible?: boolean): Contract | null {
  const { chainId } = useActiveWeb3React()
  return useContract(chainId ? '0xEDE1805200A7eB099BDE0aF07030e29e3f9755e6' : undefined, ARMY_ABI, withSignerIfPossible)
}
