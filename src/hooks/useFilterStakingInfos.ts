...
export default function useFilterStakingInfos(stakingInfos: StakingInfo[], isActive: boolean | undefined = undefined, onlyStaked: boolean | undefined = undefined): StakingInfo[] {
  return useMemo(() => {
