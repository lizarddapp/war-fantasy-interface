...
export default function getBlocksPerYear(chainId: ChainId | undefined): JSBI {
  ...
  const blocksPerMinute = blockchainSettings && blockchainSettings.blockTime ? JSBI.divide(JSBI.BigInt(60), JSBI.BigInt(blockchainSettings.blockTime)) : JSBI.BigInt(0)
